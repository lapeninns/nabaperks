...
// membership, and for a returning member load the stamp screen in place —
// before rendering or redirecting to join. Without this Suspense boundary the
// navigation freezes on the previous page (or a blank tab on a cold scan) until
// Supabase answers, at the highest-traffic customer entry point.
