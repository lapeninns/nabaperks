...
type PrivacySupportRows = Awaited<
  ReturnType<typeof getAdminPrivacySupportRows>
>
type PrivacySupportRow = PrivacySupportRows[number]

export function DataRequestWorkflowPanel({
  supportRows,
}: {
  readonly supportRows: PrivacySupportRows
}) {
  return (
    <AdminPanel>
      <SectionHeader
...
function ConsentOptOutForm({ row }: { readonly row: PrivacySupportRow }) {
  return (
    <form action={recordConsentOptOutAction} className="grid gap-2">
