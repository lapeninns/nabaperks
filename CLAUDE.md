...
The binding spec pack is [nabaperks-micro-specs-final.md](nabaperks-micro-specs-final.md) (v3). Its "Global Context for AI Agents" and [micro-specs/GLOBAL_CONTEXT.md](micro-specs/GLOBAL_CONTEXT.md) apply to all work — do not restate those rules in code, rely on them. [AGENTS.md](AGENTS.md) is the stack/governance index; [DESIGN.md](DESIGN.md) is the design system; [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) is the as-built map.
