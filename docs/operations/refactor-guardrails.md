...
| Merchant authentication | `tests/unit/merchant-auth-action-state.test.mjs`, `tests/unit/merchant-email-otp-provider.test.mjs`, `tests/unit/merchant-otp-resend.test.mjs`, `tests/unit/password.test.mjs`, `tests/unit/merchant-recovery-session-cleanup.test.mjs`, `tests/db` auth suites |
