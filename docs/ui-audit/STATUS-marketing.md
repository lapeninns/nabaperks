...
| 01#63 | High     | [ ]     | BLOCKED BY CONTRACT: legal-p3-polish (MKT-P3-14/15) requires the TOC after the article below lg. Attempted, reverted.                                                                                                 |
...
| 01#68 | Medium   | [~]     | PARTIAL: effective date was already present in all 5 metas (stale half). Print treatment added; version numbering is a product call.                                                                                  |
