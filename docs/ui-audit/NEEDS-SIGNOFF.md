...
## 25. The merchant setup reminder: 172-268px on every console route, and the audit's fix costs more than it saves
...
## 26. RA-11's fixed reward tray overlays 208px of the phone viewport, and that is the thing the audit wanted removed
