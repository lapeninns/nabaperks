...
- Token generation/readback/collection integration tests.
...
ids into the scan route. Remaining priority is integration/manual proof for
token mint, readback, collection, replay, expiry, unauthorized merchant, and
