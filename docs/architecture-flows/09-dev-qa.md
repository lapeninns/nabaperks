...
| 63 | Poster preview harness `/dev/poster-preview` | Renders real poster component with hardcoded venue defaults and generated QR data. | Poster micro-specs now assert current template ids and poster contract. | Add visual screenshots for all templates before print/export changes. |
