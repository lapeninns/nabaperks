# Nabaperks — The 28-Day First-Regular Launch

**The Complete Grand Slam Offer**

No-app QR loyalty for independent pubs · £69.99 every 28 days · Pub loyalty, sorted
...
> **A clear route to live.** Configure your venue, card, rewards and QR, then activate billing before customers join — with a done-for-you printed launch.
...
- **A guarantee with teeth.** The platform pilot stays free until a first regular returns, subject to the published conditions.
- **Honest urgency.** A real five-launches-a-week capacity limit tied to the physical print batch.
...
| **Capacity**                  | Five done-for-you launches a week, tied to the physical print batch. When a week is full, the next opening is offered honestly.                                                                                                    |
...
You raise the top and drive the bottom toward zero. Here is how The 28-Day First-Regular Launch moves each driver.
...
An unnamed offer can't be asked for. Hormozi's naming formula makes it magnetic and un-commoditisable. The wrapper is **"The 28-Day First-Regular Launch":**

| Component               | In this offer                                                |
| ----------------------- | ------------------------------------------------------------ |
| **Magnetic reason why** | The physical print batch and genuine five-launch weekly capacity. |
| **Avatar**              | UK pubs, cafes, bars and takeaways (named per surface).      |
| **Goal**                | Your first regular back — the dream outcome, stated plainly. |
| **Interval**            | 28 days — the platform pilot window.                         |
...
## 9. Scarcity & urgency: real launch capacity

Honest urgency needs something real to be scarce. Nabaperks onboards no more than five new pubs a week so each venue can be configured and its physical materials produced properly.

> ### Five done-for-you launches a week
>
> Confirm this week and your setup joins the next physical print batch. If the week is full, your launch is booked into the next available opening.

The site never invents a live availability counter or countdown. Capacity is confirmed by a human and the claim remains tied to the real work required for each launch.
...
**The 28-Day First-Regular Launch — delivered for you.** A launch-ready till poster kit, a done-for-you mystery reward pool, set-and-forget retention automations, privacy mechanisms and the operator's loyalty guides. The one-time launch fee funds the physical work.

**The First-Regular Guarantee.** The platform pilot stays free until the first regular returns, subject to the published conditions.

**Join the next print batch.** We onboard five pubs a week so each launch can be completed properly. Start your launch and we will confirm the next available opening.
...
| **Scarcity & urgency**          | Make it real; never a phony countdown.                                    | Five-launch weekly capacity, physical print batches and no invented live availability counter.       |
| **Naming (M-A-G-I-C)**          | Wrap the offer so the avatar can ask for it.                              | "The 28-Day First-Regular Launch."                                                                   |

## Appendix B. Provenance & verification

- **Single source of truth:** all copy lives in `lib/marketing/facts.ts` (`OFFER`, `PRODUCT`, `PLAN_LINE`, `DFY_LAUNCH`, `GUARANTEE`, `SCARCITY`, `URGENCY`) — no marketing surface forks a literal.
...
- **Operate the capacity promise.** Keep the five-launch weekly limit aligned with real configuration and print capacity. Do not publish availability counts without a durable reservation ledger.
