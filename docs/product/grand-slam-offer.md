...
| ---------------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **Launch-ready till poster kit**         | No time to design counter posters.    | Eight print-ready posters — five A4 counter layouts plus three B5 foldable table tents — with your venue QR and counter copy already laid out. | The kind of counter posters you'd pay a freelance designer £150+ to make.          |
