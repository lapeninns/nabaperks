...
| Hand-rolled leaf `rounded-full` ✓ circles | `DESIGN.md` §Shapes — circles are reserved for the stamp family; "new framing circles reach for `IconRoundel`".                                                                                                                       | `IconRoundel` tone leaf.                                           |
...
`columns: 1 | 2`. Uses `IconRoundel` tone leaf for the tick, not a hand-rolled
circle.
