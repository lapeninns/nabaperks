...
export function buildPosterEmailContent({
  ...
  const text = [
    `Your ${POSTER_COUNT} Nabaperks counter poster PDFs for ${venueName} are attached.`,
    "",
    "Choose a layout, then print it at 100% — no fit-to-page. Counter posters are A4; the table tent is B5 — fold top-down at the peak.",
    "",
  ...
  <body style="margin:0;background:#f6f1e6;font-family:Arial,Helvetica,sans-serif;color:#211c16;padding:24px">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;margin:0 auto;background:#fbf8f1;border:2px solid #211c16;border-radius:10px;box-shadow:4px 4px 0 #211c16">
      <tr><td style="padding:24px">
        ...
        <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#4f473d">All ${POSTER_COUNT} layouts are attached to this email. Pick the one you like, print at 100% scale — no fit-to-page. Counter posters are A4; the table tent is B5 — fold top-down at the peak.</p>
