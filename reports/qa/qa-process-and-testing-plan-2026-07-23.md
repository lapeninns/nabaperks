...
| Billing               | Stripe SDK v22, hosted Checkout (30-day trial), Customer Portal, signed webhook, pinned API `2026-07-29.dahlia`                                                                           | `lib/stripe/server.ts:7-13`; `lib/stripe/checkout.ts`; `app/api/stripe/webhook/route.ts`         |
