...
test("@contract-marketing-trust-continuity acquisition copy contains no fraud absolutes or unsupported timing", () => {
  const banned =
...
test("@contract-marketing-trust-continuity promo has a deadline and perk but no computed scarcity", () => {
...
test("@contract-marketing-trust-continuity setup and signup disclose billing and continuation price", () => {
...
test("@contract-marketing-trust-continuity public graph and copy omit unverified aggregate figures", () => {
...
test("@contract-marketing-trust-continuity claim and JSON-LD guards reject regression", () => {
