...
test("unqualified resolution and production imports into excluded tooling retain full checks", (t) => {
  ...
  for (const target of [
    ...
    "@/scripts",
    "../tests/consumer",
    "@/config/ci-qualification-inputs/scripts/consumer",
    "#page",
  ]) {
...
test("staged source proposals do not become application consumers for ordinary page selection", (t) => {
  const fixture = repository(t)
  fixture.put("app/about/page.tsx", before)
  fixture.put(
    "config/ci-qualification-inputs/tests/unit/future.test.mjs.source",
    "export const fixtureImport = (path) => import(path)\n"
  )
  const base = fixture.commit()
  fixture.put("app/about/page.tsx", copy)
  assert.equal(
    calculateImpact(base, fixture.commit(), fixture).profile,
    "public-pages"
  )
})
