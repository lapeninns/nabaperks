...
describe("customer-flow dev harness", () => {
  it("blocks the dev route in production", async () => {
    ...
    expect(isCustomerFlowDevHarnessEnabled("development")).toBe(false)
    expect(isCustomerFlowDevHarnessEnabled("test")).toBe(false)
    expect(isCustomerFlowDevHarnessEnabled("development", "true")).toBe(true)
    expect(isCustomerFlowDevHarnessEnabled("test", "true")).toBe(true)
    expect(isCustomerFlowDevHarnessEnabled("production")).toBe(false)
    expect(isCustomerFlowDevHarnessEnabled("production", "true")).toBe(false)
