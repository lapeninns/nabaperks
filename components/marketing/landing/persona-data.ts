...
export const personas: readonly Persona[] = [
  {
    ...
    hook: "Reward regulars without an app or a CRM. One venue QR covers the bar, the tables and the takeaway hatch while customers claim on their own phones.",
    spoke: ROUTES.pubHub,
    live: true,
    cta: CTA.pub,
  },
  {
    ...
    hook: "Turn the daily-habit visit into a stamp. The card opens from the till QR in the phone browser — no app and no staff entry at the till.",
