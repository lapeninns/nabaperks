...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-8 items-center justify-center border-y border-r border-input bg-input/50 text-sm transition-[color,box-shadow] duration-[var(--w-dur-fast)] ease-[var(--w-ease)] outline-none first:rounded-l-2xl first:border-l last:rounded-r-2xl motion-reduce:transition-none aria-invalid:border-destructive data-[active=true]:z-10 data-[active=true]:border-ring data-[active=true]:ring-3 data-[active=true]:ring-ring/30 data-[active=true]:aria-invalid:ring-destructive/20 dark:data-[active=true]:aria-invalid:ring-destructive/40",
        className
      )}
      {...props}
    >
